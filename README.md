...
* development of a problem solving skill
...
* All files were created and compiled on Ubuntu 20.04 with the command ```$ gcc -Wall -Werror -Wextra -pedantic -std=gnu89 *.c```
...
### Authors
* **David ONwuli** - [dcazicruz@icloud.com](https://github.com/cazicruz)
* **Progress Ochuko Eyaadah** - [koxygraphics@gmail.com](https://https:github.com/koxyG)
